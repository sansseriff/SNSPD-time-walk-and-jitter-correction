...
# It distributes an accurate clock to muliple times bewteen each clock.
...
#       that range are discarded (this is useful for scanning for the delay.
...
# (channels, timetags, clock_channel,
